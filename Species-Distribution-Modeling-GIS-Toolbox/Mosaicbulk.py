...
for year in years:
    ...
    arcpy.env.workspace = "G:\\migration\\landuse\\" + year_str  
    rasters = arcpy.ListRasters("*hdf_IGBP*", "tif")
    #print rasters
    base = rasters[0]
    ...
    out_dir= r"G:\\migration\\landuse\\world wide IGBP"
    name = "MCD12Q1_IGBP_"+year_str+'_world.tif'
